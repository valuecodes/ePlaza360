...
const listProducts = ({
    ...
    try{
        ...
        const { data } = await axios.get(`/api/products?category=${category}&searchKeyword=${searchKeyword}&sortOrder=${sortOrder}&price_from=${priceFrom}&price_to=${priceTo}&brand=${brand}`)
